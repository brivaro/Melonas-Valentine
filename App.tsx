...
const App: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-pink-50 selection:bg-valentine-200 flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-4xl flex flex-col items-center h-full justify-between py-4 md:py-8">
        ...
        <header className="text-center px-4 pt-2 w-full max-w-lg flex flex-col items-center relative z-50">
            ...
            <div className="relative mt-2">
                 <motion.button
                    ...
                    className={`flex items-center gap-2 px-5 py-2 rounded-full font-handwritten text-lg transition-all shadow-md border ${
                        isFilterOpen || filter !== 'Todos'
